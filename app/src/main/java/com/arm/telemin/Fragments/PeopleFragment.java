package com.arm.telemin.Fragments;
...
import com.arm.telemin.ChatActivity;
import com.arm.telemin.Common.Common;
import com.arm.telemin.Model.UserModel;
import com.arm.telemin.R;
import com.arm.telemin.ViewHolders.UserViewHolder;
    ...
    private void loadPeople() {
        ...
        adapter = new FirebaseRecyclerAdapter<UserModel, UserViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull UserViewHolder holder, int position, @NonNull UserModel model) {
                if (!adapter.getRef(position).get().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()))
                {
